...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE}/drill`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    ...
    { url: `${BASE}/listen/drill`, lastModified: now, changeFrequency: "monthly", priority: 0.75 },
    { url: `${BASE}/weather/decoder`, lastModified: now, changeFrequency: "monthly", priority: 0.75 },
    { url: `${BASE}/airspace/reader`, lastModified: now, changeFrequency: "monthly", priority: 0.75 },
